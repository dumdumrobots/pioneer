...
def generate_launch_description():
    ...
    pkg_ros_gz_sim_demos = get_package_share_directory('pioneer')
    ...
    rviz = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', os.path.join(pkg_ros_gz_sim_demos, 'rviz', 'pioneer.rviz')],
    ...
    slam_toolbox = Node(package='slam_toolbox',
                        ...
                        parameters=[
                            get_package_share_directory('pioneer') + '/config/mapping.yaml'
                            ],
                        output='screen',
    )
